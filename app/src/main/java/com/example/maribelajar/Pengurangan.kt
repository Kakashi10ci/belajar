...
class Pengurangan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnKurang1 = findViewById<Button>(R.id.btnKurang1)
        val btnKurang2 = findViewById<Button>(R.id.btnKurang2)
        val btnKurang3 = findViewById<Button>(R.id.btnKurang3)
        val btnKurang4 = findViewById<Button>(R.id.btnKurang4)
        val btnKurang5 = findViewById<Button>(R.id.btnKurang5)
        val btnKurang6 = findViewById<Button>(R.id.btnKurang6)
        ...
        btnKurang1.setOnClickListener {
            playSoundAndAnimate(btnKurang1, R.raw.kurang1)
        }

        btnKurang2.setOnClickListener {
            playSoundAndAnimate(btnKurang2, R.raw.kurang2)
        }

        btnKurang3.setOnClickListener {
            playSoundAndAnimate(btnKurang3, R.raw.kurang3)
        }

        btnKurang4.setOnClickListener {
            playSoundAndAnimate(btnKurang4, R.raw.kurang4)
        }

        btnKurang5.setOnClickListener {
            playSoundAndAnimate(btnKurang5, R.raw.kurang5)
        }

        btnKurang6.setOnClickListener {
            playSoundAndAnimate(btnKurang6, R.raw.kurang6)
        }
