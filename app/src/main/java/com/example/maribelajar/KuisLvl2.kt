...
class KuisLvl2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kuislv2)
        ...
        btnA.setOnClickListener {
            if (!sudahMenjawab) {
                ...
                pindahKeKuis6(btnA, btnB, btnC, btnD)
            }
        }
    ...
    private fun pindahKeKuis6(vararg buttons: Button) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            val intent = Intent(this, Kuis6::class.java)
