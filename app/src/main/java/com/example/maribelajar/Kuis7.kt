...
class Kuis7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnA.setOnClickListener {
            if (!sudahMenjawab) {
                ...
                pindahKeKuis8(btnA, btnB, btnC, btnD)
            }
        }
    ...
    private fun pindahKeKuis8(vararg buttons: Button) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            val intent = Intent(this, Kuis8::class.java)
