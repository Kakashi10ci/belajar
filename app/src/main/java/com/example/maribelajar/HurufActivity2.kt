...
class HurufActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.huruf2_activity)
        ...
        btnJ.setOnClickListener {
            playSoundAndAnimate(btnJ, R.raw.j)
        }
        btnK.setOnClickListener {
            playSoundAndAnimate(btnK, R.raw.k)
        }
        btnL.setOnClickListener {
            playSoundAndAnimate(btnL, R.raw.l)
        }
        btnM.setOnClickListener {
            playSoundAndAnimate(btnM, R.raw.m)
        }
        btnN.setOnClickListener {
            playSoundAndAnimate(btnN, R.raw.n)
        }
        btnO.setOnClickListener {
            playSoundAndAnimate(btnO, R.raw.o)
        }
        btnP.setOnClickListener {
            playSoundAndAnimate(btnP, R.raw.p)
        }
        btnQ.setOnClickListener {
            playSoundAndAnimate(btnQ, R.raw.q)
        }
        btnR.setOnClickListener {
            playSoundAndAnimate(btnR, R.raw.r)
        }
