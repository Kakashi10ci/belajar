...
class Kuis2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnJawab1.setOnClickListener {
            if (!sudahMenjawab) {
                sudahMenjawab = true
                Toast.makeText(this, "❌ Salah! Jawaban: BOLA", Toast.LENGTH_SHORT).show()
                pindahKeKuis3(btnJawab1, btnJawab2, btnJawab3, btnJawab4)
            }
        }

        // Jawaban benar (BOLA) - Dapat 4 POIN
    ...
    private fun pindahKeKuis3(vararg buttons: Button) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            val intent = Intent(this, Kuis3::class.java)
