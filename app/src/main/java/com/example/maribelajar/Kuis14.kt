...
class Kuis14 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kuis14)
        ...
        btnA.setOnClickListener {
            if (!sudahMenjawab) {
                ...
                Handler(Looper.getMainLooper()).postDelayed({
                    ...
                    intent.putExtra("NAMA", "Eci")
                    intent.putExtra("KELAS", "1")
                    intent.putExtra("SEBELUM_MEMBACA", 75)
                    intent.putExtra("SEBELUM_BERHITUNG", 70)
        ...
        btnB.setOnClickListener {
            if (!sudahMenjawab) {
                ...
                Toast.makeText(this, "❌ Jawaban Salah!", Toast.LENGTH_SHORT).show()
                disableButtons(btnA, btnB, btnC, btnD)
                btnB.setBackgroundColor(resources.getColor(android.R.color.holo_red_light))
        ...
        // Jawaban Benar (1) - Dapat 10 POIN + LANGSUNG KE HASILKUIS
        btnC.setOnClickListener {
            if (!sudahMenjawab) {
                ...
                disableButtons(btnA, btnB, btnC, btnD)
                btnC.setBackgroundColor(resources.getColor(android.R.color.holo_green_light))
                btnA.setBackgroundColor(resources.getColor(android.R.color.holo_red_light))
                btnB.setBackgroundColor(resources.getColor(android.R.color.holo_red_light))
