...
class Kuis8 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnA.setOnClickListener {
            if (!sudahMenjawab) {
                ...
                pindahKeKuis9(btnA, btnB, btnC, btnD)
            }
        }
    ...
    private fun pindahKeKuis9(vararg buttons: Button) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            val intent = Intent(this, Kuis9::class.java)
