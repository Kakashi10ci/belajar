...
class Pengurangan3 : AppCompatActivity() {

    private var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.pengurangan3)

        val btnKurang13 = findViewById<Button>(R.id.btnKurang13)
        val btnKurang14 = findViewById<Button>(R.id.btnKurang14)
        val btnKurang15 = findViewById<Button>(R.id.btnKurang15)
        val btnKurang16 = findViewById<Button>(R.id.btnKurang16)
        val btnKurang17 = findViewById<Button>(R.id.btnKurang17)
        val btnKurang18 = findViewById<Button>(R.id.btnKurang18)

        val btnKembali = findViewById<Button>(R.id.btnKembali)
        val btnSelanjutnya = findViewById<Button>(R.id.btnSelanjutnya)

        // Tombol Pengurangan dengan animasi pop up dan suara
        btnKurang13.setOnClickListener {
            playSoundAndAnimate(btnKurang13, R.raw.kurang13)
        }

        btnKurang14.setOnClickListener {
            playSoundAndAnimate(btnKurang14, R.raw.kurang14)
        }

        btnKurang15.setOnClickListener {
            playSoundAndAnimate(btnKurang15, R.raw.kurang15)
        }

        btnKurang16.setOnClickListener {
            playSoundAndAnimate(btnKurang16, R.raw.kurang16)
        }

        btnKurang17.setOnClickListener {
            playSoundAndAnimate(btnKurang17, R.raw.kurang17)
        }

        btnKurang18.setOnClickListener {
            playSoundAndAnimate(btnKurang18, R.raw.kurang18)
        }
